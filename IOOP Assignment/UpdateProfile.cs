...
namespace IOOP_Assignment
{
    public partial class UpdateProfile : UserControl
    {
        ...
        public class UpdateProfileFunctionalities
        {
            ...
            public UpdateProfileFunctionalities(string name, string password, string newUsername, string newPassword)
            {
                this.UN = name;
                this.PW = password;
            ...
            public void ForgetPassword()
            {
                ...
                {
                    MessageBox.Show("Current username cannot be empty", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                ...
                {
                    // Declare query to execute
                    string setPasswordQuery = "UPDATE login_database SET password = 'password' WHERE username LIKE @Username";
                    ...
                    using (SqlCommand cmd = new SqlCommand(setPasswordQuery, connection))
                    {
                        ...
                        // Replaces string with user inputted value
                        cmd.Parameters.AddWithValue("@Username", UN);
        ...
        private void linklbl_forgetpw_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            // Object instantiation and method calling
            UpdateProfileFunctionalities functionalities = new UpdateProfileFunctionalities(currentUN, null, null, null);
